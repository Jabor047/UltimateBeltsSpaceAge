...
{
  {
    ...
    icon = "__UltimateBeltsSpaceAge__/graphics/icons/extreme-fast-belts/ultimate-transport-belt.png",
    icon_size = 32,
    subgroup = "belt",
  ...
  
 {
    ...
    belt_animation_set = 
    {
      animation_set = 
      {
        filename = "__UltimateBeltsSpaceAge__/graphics/entity/extreme-fast-belts/ultimate-transport-belt.png",
        priority = "extra-high",
        width = 64,
        height = 64,
        frame_count = 32,
        ...
        hr_version =
        {
          filename = "__UltimateBeltsSpaceAge__/graphics/entity/extreme-fast-belts/hr-ultimate-transport-belt.png",
          priority = "extra-high",
          width = 128,
          height = 128,
          scale = 0.5,
